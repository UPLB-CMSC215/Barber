...
class Index:
    def __init__(self, root):
        ...
        self.welcomeMessage = customtkinter.CTkLabel(master=self.welcomeMessageFrame, text="Barbers Algorith", text_color="#C3C3C3", bg_color="transparent", fg_color="transparent", font=customtkinter.CTkFont(size = 12))
