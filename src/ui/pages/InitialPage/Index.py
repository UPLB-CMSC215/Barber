...
class Index(customtkinter.CTk):
    def __init__(self):
        ...
        self.title("BARBERS DATABASE")
        self._set_appearance_mode('dark')
        self.resizable(False, False)
        self.description = "This is a project requirement for the course `CMSC 215: Advanced Computer Systems WX (First Sem 2025-2026)`. It must not be used in production, reproduced, or distributed to fulfill the same course requirements. You may only use this as a reference for future work."
        ...
        self.welcomeMessage = customtkinter.CTkLabel(master=self.mainFrame, text="BARBERS ALGORITHM", text_color="#F3F3F3", bg_color="transparent", fg_color="transparent", font=customtkinter.CTkFont(size = 36))
        self.welcomeMessage.grid(row=2, column=0, pady="0", sticky="nsew")

        self.welcomeMessage = customtkinter.CTkLabel(master=self.mainFrame, text="Single Sleeping Barber Problem Simulation", text_color="#F3F3F3", bg_color="transparent", fg_color="transparent", font=customtkinter.CTkFont(size = 12))
        ...
        self.welcomeMessage.grid(row=4, column=0, padx=50, pady="10", sticky="ns")
        ...
        self.proceedBtn.grid(row=6, column=0, pady="10", padx=100, ipady="5",  sticky="nsew")
    ...
    def proceed (self, e):
        self.proceedBtn.configure(state="disabled", text="Opening the barber shop")
